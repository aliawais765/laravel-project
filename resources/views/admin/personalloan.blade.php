...
<div class="container">
  <div class="profile-table">
    <h3 class="mb-4 text-center">personal-loan</h3>
    @if (session('success'))
  ...
  @endif
    <table class="table table-hover align-middle text-center">
      ...
      <td >{{ $bankloan->notes }} <td><a href="{{route('editpersonalloan',$bankloan->id)}}"><button class="btn btn-edit btn-sm me-2">Edit</button></a></td><td><form action="{{ route('deletepersonalloan', $bankloan->id) }}" method="POST">
    @csrf
    @method('DELETE')
